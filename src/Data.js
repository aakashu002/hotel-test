...
import { Link } from 'react-router-dom';
 ...
 render() {
        ...
        <div class="" >
          ...
          <Link class="dropdown-item" to="/Resturent" >Hometown BBQ</Link>
          <Link class="dropdown-item" to="/Resturent" >Superiority Burger</Link>
          <Link class="dropdown-item" to="/Resturent" >The Dutch</Link>
          <Link class="dropdown-item" to="/Resturent" >Mu Ramen</Link>
          <Link class="dropdown-item" to="/Resturent" >Casa Enrique</Link>
